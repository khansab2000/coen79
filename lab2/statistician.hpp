...
namespace coen79_lab2
{
    ...
    public:
        ...
        double lastt() const {return last;}
        double mean() const;
        double minimum() const;
        double maximum() const;
    ...
    private:
        ...
        double total;      // sum of all the numbers in the sequence
        double smallest;  // smallest number in the sequence
        double largest;  // largest number in the sequence
        double last;    // last number in the sequence
    };
    bool operator ==(const statistician& s1, const statistician& s2);
}
